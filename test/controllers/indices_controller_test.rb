...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post indices_url, params: { index: { Description: @index.Description, Tags: @index.Tags, Title: @index.Title } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { Description: @index.Description, Tags: @index.Tags, Title: @index.Title } }
